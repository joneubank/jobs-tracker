...
import { clamp, cloneDeep, get, isArray, update } from 'lodash';
...
import { Job, JobDefinition, JobStatus } from '../model/jobs/types';
import { isJob } from '../model/jobs/validators';
...
export function parseEsResponse(response: any): Job | undefined {
  ...
  const dateProps = ['createdAt', 'startedAt', 'cancelledAt', 'completedAt', 'errorAt'];
